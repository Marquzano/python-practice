...
# code I have so far
# may work better using RegEx
class Solution:
    def simplifyPath(self, path: str) -> str:
        # lets say for example
        # /home/workspace//../workspace/./python-practice/hacckerrank/../..
        # comes to:
        # /home/workspace

        # we need to have a list of the different directories names including '...'
        # not including '/' '.' or '..'
        ...
        for delimiter in delimiters:
            pathString = ' '.join(path.split(delimiter))

        directories = pathString.split()
